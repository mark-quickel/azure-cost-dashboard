...
namespace AzureCostDashboardFunction.Services
{
    public class BillingAccountService 
    {
        ...
        private readonly static string _endpoint = Environment.GetEnvironmentVariable("AZURE_BILLINGACCOUNTS_ENDPOINT");

        public BillingAccountService(string accessToken)
        {
